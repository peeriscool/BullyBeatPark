...
public class CursorControls : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Mouse.current.middleButton.wasPressedThisFrame) //move cam
        {
            camtrigger = true;

        }
        if (Mouse.current.rightButton.wasPressedThisFrame) //move cam
        {
    ...
    float CameraFloorDetection(Vector3 _mouspos)
    {
